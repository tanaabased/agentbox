...
pin_path="$(brew --prefix)/var/homebrew/pinned/openclaw-cli"
test -L "$pin_path"
test "$(cd "$pin_path" && pwd -P)" = "$(brew --cellar)/openclaw-cli/2026.7.1"
...
# should reject a different openclaw baseline without replacing the installed version
